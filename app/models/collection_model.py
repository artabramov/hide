...
class Collection(Base):
    """
    SQLAlchemy model for a document collection. Defines a collection of
    documents with metadata such as creation and update dates, user
    association, and collection details including name, summary, and
    document statistics. Manages relationships with users and documents.
    """
    ...
    def to_dict(self):
        ...
        name, summary, document count, document size, and details of
        the associated user.
        """
        return {
            "id": self.id,
