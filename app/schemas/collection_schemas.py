...
class CollectionSelectResponse(BaseModel):
    ...
    counts for mediafiles and revisions, associated with the
...
class CollectionListRequest(BaseModel):
    ...
    mediafiles_count__ge: Optional[int] = None
    mediafiles_count__le: Optional[int] = None
    ...
    order_by: Literal["id", "created_date", "updated_date", "user_id",
                      "collection_name", "mediafiles_count", "revisions_count",
                      "revisions_size"]
